...
2. Hashtags: Provide EXACTLY 5 hashtags. Four of them MUST always be '유머', '공감', '오리한의원', and '대구'. The remaining one should be a keyword representing the specific topic/title of the video (소재 제목).`;
