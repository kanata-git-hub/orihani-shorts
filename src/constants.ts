...
- **활용된 레퍼런스:** [CRITICAL: You MUST explicitly specify which of the 20 Master Examples you selected as your structural baseline (e.g., "Reference #7: Is It Cake?"). Do NOT invent generic 'weak -> medicine -> strong' plots. Focus on relatable, cute everyday moments without forcing unnecessary twists.]
